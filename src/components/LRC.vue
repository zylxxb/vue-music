<template>
  <div class="lrcContainer">
    <div class="lrc" ref="lrc">
      {{ getAllKey }}
      <!-- <p v-show="(parseInt(currentTime) >= keyArr[index]) && (parseInt(currentTime) < keyArr[index+10])" class="lrc-p" v-for="(item,key,index) in lrcData" :key="index">
        {{ item }} ---  {{ parseInt(currentTime) }}
      </p> -->
      <p
      class="lrc-p"
