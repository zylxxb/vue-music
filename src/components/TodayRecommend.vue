<template>
  <div class="mod-albums">
    ...
    <div class="container">
        <div class="gallery">
            <div class="scroller">
                <router-link :to="{name: 'musicplay', params: {songID:item.song_id}}" tag='div' class="card url" v-for="(item,index) in musicLists" :key="index">
                    <div class="album">
...
export default {
  ...
  created() {
    ...
    this.$axios.get(url).then( res=> {
      this.musicLists = res.data.song_list
    }).catch( error=> {
      console.log(error);
    })
  }
